          ...
          {data.sheets.map((s, i) => (
            <button
              ...
              style={{
                ...
                borderTop: i === activeSheet ? "0.5px solid #E8E8E8" : "0.5px solid transparent",
                borderRight: i === activeSheet ? "0.5px solid #E8E8E8" : "0.5px solid transparent",
                borderLeft: i === activeSheet ? "0.5px solid #E8E8E8" : "0.5px solid transparent",
